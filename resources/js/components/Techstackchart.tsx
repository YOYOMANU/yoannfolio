 ...
 * utilisées à travers tes projets (calculé depuis ta table
...
export const mockTechStack: TechUsage[] = [
    { name: "Laravel", value: 6 },
    { name: "React/TS", value: 5 },
    { name: "PostgreSQL", value: 4 },
    { name: "Inertia.js", value: 4 },
    { name: "React Native", value: 2 },
    { name: "Kotlin", value: 1 },
];